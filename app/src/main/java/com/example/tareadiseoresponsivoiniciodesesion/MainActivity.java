...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> Toast.makeText(getApplicationContext(), "Has seleccionado Usuario y contraseña", Toast.LENGTH_SHORT).show());

        button2.setOnClickListener(v -> Toast.makeText(getApplicationContext(), "Has seleccionado Huella / Face ID", Toast.LENGTH_SHORT).show());

        button3.setOnClickListener(v -> Toast.makeText(getApplicationContext(), "Has seleccionado Pin de 6 dígitos", Toast.LENGTH_SHORT).show());
